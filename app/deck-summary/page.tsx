...
const majorArcana = [
  ...
  { number: 3, name: 'The Brunch Hostess', emoji: '🌸🥂', traditional: 'The Empress', meaning: 'Abundance is flowing — receive it gracefully.' },
...
const minorArcana = {
  pancakes: {
    ...
    cards: [
      ...
      { number: '2', name: 'Two', emoji: '🥞⚖️🥞', meaning: 'Balance your priorities — you can juggle this.' },
      ...
      { number: '7', name: 'Seven', emoji: '🥞🌱⏳', meaning: 'The batter is rising — be patient.' },
      { number: '8', name: 'Eight', emoji: '🥞📚', meaning: 'Master your craft — every flip teaches you something.' },
      { number: '9', name: 'Nine', emoji: '🥞🏡😌', meaning: 'You\'ve built something comfortable — enjoy it.' },
  ...
  coffee: {
    ...
    cards: [
      ...
      { number: '5', name: 'Five', emoji: '☕😢☕☕', meaning: 'Don\'t mourn the spilled cups — see what remains.' },
      { number: '6', name: 'Six', emoji: '☕👶🏠', meaning: 'Sweet memories of simpler times.' },
      { number: '7', name: 'Seven', emoji: '☕🌈☁️', meaning: 'So many choices — not all of them are real.' },
  ...
  butter: {
    ...
    cards: [
      ...
      { number: '2', name: 'Two', emoji: '🧈🌍', meaning: 'You\'re planning something big — keep dreaming.' },
      { number: '3', name: 'Three', emoji: '🧈🚢', meaning: 'Your efforts are shipping out — watch for returns.' },
      ...
      { number: '8', name: 'Eight', emoji: '🧈💨🎯', meaning: 'Everything is moving fast — stay focused.' },
      { number: '9', name: 'Nine', emoji: '🧈😰🩹', meaning: 'You\'re tired but not done — one more push.' },
      { number: '10', name: 'Ten', emoji: '🧈😫📦', meaning: 'You\'re carrying too much — put something down.' },
  ...
  syrup: {
    ...
    cards: [
      { number: 'A', name: 'Ace', emoji: '🍯✨', meaning: 'A breakthrough thought — clarity at last.' },
      ...
      { number: '5', name: 'Five', emoji: '🍯😈🏆', meaning: 'Someone won unfairly — don\'t sink to their level.' },
      ...
      { number: '10', name: 'Ten', emoji: '🍯🔚🌅', meaning: 'The worst is over — dawn is coming.' },
