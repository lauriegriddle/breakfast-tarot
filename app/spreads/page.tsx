...
const allCards = [
  ...
  { id: 3, name: 'The Brunch Hostess', emoji: '🌸🥂', type: 'major', meaning: 'Abundance is flowing so receive it gracefully.', fullMeaning: 'The Brunch Hostess creates spaces where everyone feels welcome and fed. Abundance isn\'t just about having; it\'s about receiving, sharing, and celebrating. Let good things in.' },
  ...
  { id: 7, name: 'The Food Truck', emoji: '🚚💨', type: 'major', meaning: 'Keep moving forward because momentum is your friend.', fullMeaning: 'The Food Truck doesn\'t wait for customers to find it:  it goes where it\'s needed. You have the drive and direction. Trust your ability to navigate and keep rolling.' },
  ...
  { id: 10, name: 'The Specials Board', emoji: '🎡📋', type: 'major', meaning: 'The menu changes so roll with it.', fullMeaning: 'Life serves different specials every day. What was available yesterday might not be today, and tomorrow brings new options. Stay flexible and trust the rotation.' },
  ...
  { id: 17, name: 'The Tip Jar', emoji: '⭐🫙', type: 'major', meaning: 'Small kindnesses ripple outward.', fullMeaning: 'Every dollar in the Tip Jar represents someone who received good service and wanted to give back. Hope, generosity, and trust in abundance so pay it forward.' },
  ...
  { id: 21, name: 'The Full Breakfast', emoji: '🌍🍽️', type: 'major', meaning: 'The journey is complete so savor every bite.', fullMeaning: 'Everything on the plate, nothing left out. The Full Breakfast is wholeness, completion, and celebration of the entire journey. You made it. Enjoy.' },
  ...
  { id: 28, name: 'Seven of Pancakes', emoji: '🥞🌱⏳', type: 'pancakes', meaning: 'The batter is rising just be patient.', fullMeaning: 'You\'ve done the work, now wait for results. Like watching batter rise, you can\'t rush this part. Trust that your efforts will yield a harvest.' },
  ...
  { id: 30, name: 'Nine of Pancakes', emoji: '🥞🏡😌', type: 'pancakes', meaning: 'You\'ve built something comfortable so enjoy it.', fullMeaning: 'A cozy kitchen, a full pantry, peace of mind. You\'ve worked hard and created security. Take a moment to appreciate what you\'ve achieved.' },
  ...
  { id: 37, name: 'Two of Coffee', emoji: '☕💕☕', type: 'coffee', meaning: 'Connection across the table.', fullMeaning: 'Two cups facing each other in partnership, mutual attraction, and harmony. Whether romantic or platonic, there\'s a real connection here.' },
  ...
  { id: 40, name: 'Five of Coffee', emoji: '☕😢☕☕', type: 'coffee', meaning: 'Don\'t mourn the spilled cups just see what remains.', fullMeaning: 'Some cups have fallen, and the grief is real. But look, not all is lost. The Five of Coffee asks you to acknowledge loss while seeing what\'s still standing.' },
  ...
  { id: 42, name: 'Seven of Coffee', emoji: '☕🌈☁️', type: 'coffee', meaning: 'So many choices but not all of them are real.', fullMeaning: 'A display of beautiful cups, each promising something wonderful. But which are real and which are fantasy? Discernment needed.' },
  ...
  { id: 49, name: 'King of Coffee', emoji: '☕👑🎭', type: 'coffee', meaning: 'Master of emotional balance.', fullMeaning: 'He feels everything but isn\'t ruled by feelings. The King of Coffee brings emotional maturity and wisdom from having navigated the full range of human experience.' },
  ...
  { id: 51, name: 'Two of Butter', emoji: '🧈🌍', type: 'butter', meaning: 'You\'re planning something big so keep dreaming.', fullMeaning: 'Standing at the edge of possibility, surveying what could be built. The Two of Butter is about vision and deciding where to spread your energy.' },
  { id: 52, name: 'Three of Butter', emoji: '🧈🚢', type: 'butter', meaning: 'Your efforts are shipping out so watch for returns.', fullMeaning: 'What you\'ve created is going into the world. Expansion, growth, and waiting to see how your ventures land. Progress is real.' },
  ...
  { id: 56, name: 'Seven of Butter', emoji: '🧈🛡️', type: 'butter', meaning: 'Hold your ground. Don\'t let them take your griddle.', fullMeaning: 'Defending your position, protecting what you\'ve built, standing firm against opposition. You have the high ground so use it.' },
  { id: 57, name: 'Eight of Butter', emoji: '🧈💨🎯', type: 'butter', meaning: 'Everything is moving fast so stay focused.', fullMeaning: 'Rapid progress, things happening quickly, momentum building. The Eight of Butter says hold on and direct this energy wisely.' },
  { id: 58, name: 'Nine of Butter', emoji: '🧈😰🩹', type: 'butter', meaning: 'You\'re tired but not done.  Just one more push.', fullMeaning: 'Battle-worn but still standing. The Nine of Butter acknowledges your exhaustion while reminding you that you have reserves. Almost there.' },
  ...
  { id: 64, name: 'Ace of Syrup', emoji: '🍯✨', type: 'syrup', meaning: 'A breakthrough thought brings clarity at last.', fullMeaning: 'Mental breakthrough, a new idea, truth cutting through confusion. The Ace of Syrup brings intellectual clarity and the power of a clear mind.' },
  ...
  { id: 68, name: 'Five of Syrup', emoji: '🍯😈🏆', type: 'syrup', meaning: 'Someone won unfairly just don\'t sink to their level.', fullMeaning: 'Defeat through dishonesty or cruelty. The Five of Syrup acknowledges the sting of unfair loss. Your integrity matters more than this battle.' },
  ...
  { id: 70, name: 'Seven of Syrup', emoji: '🍯🦊', type: 'syrup', meaning: 'Be clever because not everyone needs to know your recipe.', fullMeaning: 'Strategy, stealth, and playing your cards close. The Seven of Syrup isn\'t about dishonesty:  it\'s about wisdom in what you reveal and when.' },
  ...
  { id: 73, name: 'Ten of Syrup', emoji: '🍯🔚🌅', type: 'syrup', meaning: 'The worst is over and dawn is coming.', fullMeaning: 'Rock bottom has a foundation. The Ten of Syrup marks the end of a painful mental cycle. You survived the darkest hour. Now: healing.' },
...
const spreads = [
  ...
  },
  {
    ...
    emoji: '🍳',
    cardCount: 5,
    description: 'The complete meal of eggs, toast, bacon, pancakes, and coffee. This comprehensive spread leaves nothing on the table. For when you need the whole picture.',
